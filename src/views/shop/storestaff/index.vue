  ...
  <div class="app-container">
    ...
    <div class="head-container">
      ...
      <el-table ref="table" v-loading="crud.loading" :data="crud.data" size="small" style="width: 100%;" @selection-change="crud.selectionChangeHandler">
        ...
        <el-table-column v-permission="['admin','SystemStoreStaff:edit','SystemStoreStaff:del']" label="操作" width="150px" align="center">
          <template slot-scope="scope">
            <udOperation
              :data="scope.row"
...
<script>
import crudSystemStoreStaff from '@/api/SystemStoreStaff'
...
import crudSystemStore from '@/api/SystemStore'

// crud交由presenter持有
const defaultCrud = CRUD({ title: '门店店员', url: 'api/SystemStoreStaff', sort: 'id,desc', crudMethod: { ...crudSystemStoreStaff }})
...
export default {
  ...
  data() {
    return {
      mystores: [],
      permission: {
        add: ['admin', 'SystemStoreStaff:add'],
        edit: ['admin', 'SystemStoreStaff:edit'],
        del: ['admin', 'SystemStoreStaff:del']
      },
      rules: {
        // uid: [
