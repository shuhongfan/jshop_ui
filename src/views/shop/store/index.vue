  ...
  <div class="app-container">
    ...
    <div class="head-container">
      ...
      <el-table ref="table" v-loading="crud.loading" :data="crud.data" size="small" style="width: 100%;" @selection-change="crud.selectionChangeHandler">
        ...
        <el-table-column v-permission="['admin','SystemStore:edit','SystemStore:del']" label="操作" width="150px" align="center">
          <template slot-scope="scope">
            <udOperation
              :data="scope.row"
...
<script>
  ...
  // crud交由presenter持有
  const defaultCrud = CRUD({ title: '门店', url: 'api/SystemStore', sort: 'id,desc', crudMethod: { ...crudSystemStore }})
  ...
  export default {
    ...
    data() {
      return {
        permission: {
          add: ['admin', 'SystemStore:add'],
          edit: ['admin', 'SystemStore:edit'],
          del: ['admin', 'SystemStore:del']
        },
        rules: {
          name: [
    ...
    methods: {
      ...
      getL(addr) {
        crudSystemStore.getL({addr}).then(res => {
