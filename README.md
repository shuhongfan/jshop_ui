<h1 style="text-align: center">jshop意象商城系统</h1>


#### 项目简介
jshop基于当前流行技术组合的前后端分离商城系统： SpringBoot2+MybatisPlus+SpringSecurity+jwt+redis+Vue的前后端分离的商城系统， 包含商城、拼团、砍价、商户管理、 秒杀、优惠券、积分、分销、会员、充值、多门店等功能，更适合企业或个人二次开发；；
...
|     |  后台系统源码 |   后台系统前端源码  |
|---  |--- | --- |
|   码云  |  https://gitee.com/guchengwuyue/jshopmall  | https://gitee.com/guchengwuyue/jshopmall_qd |
|   github   |  https://github.com/guchengwuyue/jshopmall |https://github.com/guchengwuyue/jshopmall_qd  |
...
- jshop-logging   日志模块
- jshop-tools     第三方工具模块
- jshop-generator 代码生成模块
- jshop-shop      商城模块
- jshop-mproot    mybatisPlus
